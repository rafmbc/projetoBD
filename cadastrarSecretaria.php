...
<?php
    ...
    echo "<p class='center' style='text-align: center;'>Inserindo registro da tabela Animal...</p>";
            ...
            echo "<tr><form name='inserirSecretaria' action='insereSecretaria.php' method='post'>
            <input type='hidden' name='tabela' value='Secretaria'>
            <th><input type='text' name='nomeSecretaria'></th>
            <th><input type='number' name='telefoneSecretaria'></th>
