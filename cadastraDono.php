...
<?php
    ...
    echo "<p class='center' style='text-align: center;'>Inserindo registro da tabela Donos...</p>";
            echo "<style>
            .styled-table {
                width: 100%;
            ...
            echo "<tr><form name='inserirDono' action='insereDono.php' method='post'>
                <input type='hidden' name='tabela' value='Donos'>
                <th><input type='number' name='cpfDono'></th>
                <th><input type='text' name='nome'></th>
                <th><input type='number' name='telefone'></th>
                <th><input type='text' name='endereco'></th>
