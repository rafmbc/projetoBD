...
<?php
    ...
    $sql = "DELETE FROM Donos WHERE cpfDono=?";
    ...
    $stmt->bind_param("i", $cpfDono); 
    
    if ($stmt->execute()) {
        echo "<p class='center'>Dono deletado com sucesso!</p>";
    } else {
        echo "<p class='center'>Erro ao deletar dono: " . $stmt->error . "</p>";
    }
