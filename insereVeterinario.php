...
<?php
    ...
    try {
        ...
        $stmt = $conn->prepare("INSERT INTO Veterinario (crmv, nomeVeterinario, tipoEspecializacao, telefone) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("issi", $crmv, $nomeVeterinario,$tipoEspecializacao,$telefone);
        $stmt->execute();
